...
export const sprites = defineSpriteMap([
  defineSprite('common', [
    defineSpriteAsset(
      [
        defineSpriteSymbol(['cart'], [16]),
        defineSpriteSymbol(['check'], [16]),
        defineSpriteSymbol(['circle-squares'], [16]),
        defineSpriteSymbol(['loading'], [24]),
        defineSpriteSymbol(['minus'], [16]),
        defineSpriteSymbol(['plus'], [16]),
        defineSpriteSymbol(['trash'], [16]),
      ],
      defineExternalAssetMeta('common.3df26245.svg'),
    ),
  ]),
]);

export type SpritesMeta = {
  common: 'cart' | 'check' | 'circle-squares' | 'loading' | 'minus' | 'plus' | 'trash';
};
